...
function App() {
  ...
  var addThought = function addThought(thoughts) {
    setThoughts(function (prevThought) {
      return [thoughts].concat(_toConsumableArray(prevThought));
    });
  };

  var removeThought = function removeThought(thoughtIdToRemove) {
    var thoughtToRemove = thoughts.filter(function (thought) {
      return thought.id !== thoughtIdToRemove;
    });
    setThoughts(thoughtToRemove);
  };
